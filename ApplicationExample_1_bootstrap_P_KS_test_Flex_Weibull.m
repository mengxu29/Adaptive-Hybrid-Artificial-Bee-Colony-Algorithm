function ApplicationExample_1_bootstrap_P_KS_test_Flex_Weibull()
global lifes;
...
Func_Paras.ub = [10 10];%[1.9 10 max_eta]; %/*lower bounds of the parameters. */
...
ABC_Paras.limit=100; %/*A food source which could not be improved through "limit" trials is abandoned by its employed bee*/
...
save data_ApplicationExample_1_bootstrap_P_KS_test_Flex_Weibull
...
neg_loglik_vector = -(log(alpha+beta./(t.^2))+(alpha*t-beta./t)-exp(alpha*t-beta./t));
