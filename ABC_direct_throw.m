function [GlobalMins,solutions]=ABC_direct_throw()
...
maxCycle=2000; %/*The number of cycles for foraging {a stopping criteria}*/
maxBestTrial = 1000;
deltaObj = 1e-16;
...
%% %%%%%%% EMPLOYED BEE PHASE %%%%%%%%%%%%%%%%%%%%%%%%
    for i=1:(FoodNumber)
       ...
       sol(Param2Change)=Foods(i,Param2Change)+(Foods(i,Param2Change)-Foods(neighbour,Param2Change))*(rand-0.75)*2;
