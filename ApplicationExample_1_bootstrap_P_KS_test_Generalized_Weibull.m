function ApplicationExample_1_bootstrap_P_KS_test_Generalized_Weibull()
global lifes;
...
ABC_Paras.C = 1;
ABC_Paras.Ns = 5;
ABC_Paras.runtime = 2;%/*Algorithm can be run many times in order to see its robustness*/
...
if(paras(3)>0 && 9.701 > (paras(1)*paras(3))^(-1/paras(2)))
    b = 0;
else
